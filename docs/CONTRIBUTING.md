...
[create a proposal](https://github.com/zfcampus/zf-rpc/issues/new).
...
- Clone the repository:
  ...
  ```console
  $ git clone git://github.com/zfcampus/zf-rpc.git
  $ cd zf-rpc
  ```
...
2. Fork the repository (https://github.com/zfcampus/zf-rpc)
...
4. Add a remote to your fork; substitute your GitHub username in the command
   ...
   ```console
   $ git remote add {username} git@github.com:{username}/zf-rpc.git
   $ git fetch {username}
   ```
...
To ssh://git@github.com/{username}/zf-rpc.git
